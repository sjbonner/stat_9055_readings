...
$$
To compute this we need to compute the standard error of the raw residual. Full details are provided in Section 4.5.7 of \citet{agresti2013} and I won't reproduce them here. The final result is that the standardized residual for the $i^{th}$ observation is 
$$
