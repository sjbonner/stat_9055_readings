...
execute: 
  ...
  warning: false
  include: false
bibliography: 9_multinomial_regression_1
---
...
The example we're going to consider is one of my favourite data sets -- and I didn't make it up. The data come from a \textit{real} study of the food preferences of alligators living in four lakes in Florida and were collected by Dr. M.F. Delaney and Dr. C.T. Moore. \citep[pg. 294]{agresti2013} describes the experiment as follows:
\begin{quote}
  ``The study captured 219 alligators in four Florida lakes. The nomial response variable is the primary food type, in volume, found in the alligator's stomach. This had five categories: fish, invertebrate, reptile, bird, other.''
\end{quote}
